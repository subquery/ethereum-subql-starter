    ...
    dataSources: [
        {
            ...
            assets: new Map([
                ...
                ['AccessControlledOffchainAggregator', { file: "./abis/AccessControlledOffchainAggregator.json" }]
            ]),
            mapping: {
                file: "./dist/index.js",
                handlers: [
                    {
                        ...
                        filter: {
                            topics: ["FeedConfirmed(address,address,address,address,uint16,address)"],
                        },
                    },
                ],
            },
