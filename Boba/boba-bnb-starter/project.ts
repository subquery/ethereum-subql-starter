...
const project: EthereumProject = {
    ...
    description: "This project can be use as a starting point for developing your new Boba BNB SubQuery project",
    runner: {
        node: {
    ...
    network: {
        /**
         * chainId is the EVM Chain ID, for Boba BNB testnet this is 56288
