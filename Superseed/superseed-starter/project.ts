...
const project: EthereumProject = {
  ...
  network: {
    /**
     * chainId is the EVM Chain ID, for Superseed this is 5330
     * https://chainlist.org/chain/5330
     */
    chainId: "5330",
    /**
  ...
  dataSources: [
    {
      ...
      mapping: {
        ...
        handlers: [
          {
            kind: EthereumHandlerKind.Call, // We use ethereum handlers since Superseed is EVM-compatible
