...
const project: EthereumProject = {
  ...
  description:
    "This project can be use as a starting point for developing your new Gravity Alpha SubQuery project",
  runner: {
    node: {
  ...
  network: {
    /**
     * chainId is the EVM Chain ID, for Gravity Alpha this is 1625
     ...
     */
    endpoint: ["https://rpc.gravity.xyz/"],
  },
  dataSources: [
    {
