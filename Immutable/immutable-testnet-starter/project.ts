...
const project: EthereumProject = {
    specVersion: "1.0.0",
    version: "0.0.1",
    name: "immutable-testnet-subql-starter",
    description: "This project can be use as a starting point for developing your new Immutable Testnet project",
    runner: {
        node: {
    ...
    network: {
        /**
         * chainId is the EVM Chain ID, for Immutable this is 13472
         * https://chainlist.org/chain/13472
         */
        chainId:
            "13472",
        /**
