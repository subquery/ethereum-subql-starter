    ...
    dataSources: [
        {
            ...
            assets: new Map([
                ['plasma', { file: "./abis/plasma.abi.json" }],
            ]),
            mapping: {
                file: "./dist/index.js",
                handlers: [
                    {
                        ...
                        filter: {
                            topics: ["TokenDeposited (address indexed rootToken, address indexed childToken, address indexed user, uint256 amount, uint256 depositCount)"],
                        },
                    },
                    {
                        kind: EthereumHandlerKind.Event,
                        handler: "handleDeposit",
                        filter: {
                            topics: ["TokenWithdrawn (address indexed rootToken, address indexed childToken, address indexed user, uint256 amount, uint256 withrawCount)"],
                        },
                    },
                ],
            },
