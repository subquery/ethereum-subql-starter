...
const project: EthereumProject = {
  ...
  network: {
    /**
     * chainId is the EVM Chain ID, for XDC Network this is 50
  ...
  dataSources: [
    {
      ...
      options: {
        ...
        address: "0x1ebb2c8a71a9ec59bf558886a8adf8f4a565814f",
      },
      ...
      mapping: {
        ...
        handlers: [
          {
            kind: EthereumHandlerKind.Call, // We use ethereum handlers since XDC Network is EVM-compatible
