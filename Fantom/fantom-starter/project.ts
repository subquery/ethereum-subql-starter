...
const project: EthereumProject = {
    ...
    version: "0.0.1",
    name: "fantom-starter",
    description: "This project can be use as a starting point for developing your new Fantom Opera SubQuery project",
    runner: {
        node: {
    ...
    network: {
         ...
         */
        endpoint: ["https://rpcapi.fantom.network", "https://fantom.publicnode.com"],
