...
const project: EthereumProject = {
  ...
  description:
    "This project can be use as a starting point for developing your new Fantom SubQuery project",
  runner: {
    node: {
  ...
  network: {
    /**
     * chainId is the EVM Chain ID, for Fantom this is 4002
  ...
  dataSources: [
    {
      ...
      mapping: {
        ...
        handlers: [
          {
            kind: EthereumHandlerKind.Call, // We use ethereum handlers since Fantom Testnet is EVM-compatible
