...
const project: EthereumProject = {
  ...
  description:
    "This project can be use as a starting point for developing your new Zetachain SubQuery project",
  runner: {
    node: {
  ...
  network: {
    /**
     * chainId is the EVM Chain ID, for Zetachain this is 7000
     * https://chainlist.org/chain/7000
     */
    chainId: "7000",
    /**
