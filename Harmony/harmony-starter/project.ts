...
const project: EthereumProject = {
    ...
    description: "This project can be use as a starting point for developing your new Harmony project",
    runner: {
        node: {
    ...
    network: {
        /**
         * chainId is the EVM Chain ID, for Harmony this is 1666600000
