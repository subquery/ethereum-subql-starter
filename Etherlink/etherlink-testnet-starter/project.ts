...
const project: EthereumProject = {
  ...
  network: {
     ...
     */
    endpoint: ["https://node.ghostnet.etherlink.com"],
  },
  dataSources: [
    {
      ...
      options: {
        abi: "erc20",
        // This is the contract address for Wrapped XTZ
      ...
      mapping: {
        ...
        handlers: [
          {
            kind: EthereumHandlerKind.Call, // We use ethereum handlers since Etherlink Testnet is EVM-compatible
