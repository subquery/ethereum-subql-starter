...
export async function handleSwap(
  ...
  pancakeSwapDayData.volumeETH =
    pancakeSwapDayData.volumeETH + amountTotalETHTracked.toNumber();
  pancakeSwapDayData.volumeUSD =
    pancakeSwapDayData.volumeUSD + amountTotalUSDTracked.toNumber();
  pancakeSwapDayData.feesUSD = pancakeSwapDayData.feesUSD + feesUSD.toNumber();
