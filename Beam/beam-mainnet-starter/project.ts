...
const project: EthereumProject = {
  ...
  name: "beam-starter",
  description:
    "This project can be use as a starting point for developing your new Beam SubQuery project",
  runner: {
    node: {
  ...
  network: {
    /**
     * chainId is the EVM Chain ID, for Beam this is 4337
     * https://chainlist.org/chain/4337
     */
    chainId: "4337",
    /**
     ...
     */
    endpoint: ["https://build.onbeam.com/rpc"],
  },
  dataSources: [
    {
