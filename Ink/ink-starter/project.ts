...
const project: EthereumProject = {
  ...
  network: {
    /**
     * chainId is the EVM Chain ID, for Ink this is 57073
     ...
     */
    endpoint: ["https://rpc-qnd.inkonchain.com"],
  },
  dataSources: [
    {
      ...
      mapping: {
        ...
        handlers: [
          {
            kind: EthereumHandlerKind.Call, // We use ethereum handlers since Ink is EVM-compatible
