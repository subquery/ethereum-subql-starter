...
const project: EthereumProject = {
  ...
  network: {
    /**
     * chainId is the EVM Chain ID, for Zircuit this is 48900
     ...
     */
    endpoint: ["https://mainnet.zircuit.com"],
  },
  dataSources: [
    {
      ...
      mapping: {
        ...
        handlers: [
          {
            kind: EthereumHandlerKind.Call, // We use ethereum handlers since Zircuit is EVM-compatible
