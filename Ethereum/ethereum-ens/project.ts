...
const project: EthereumProject = {
    ...
    dataSources: [
        // ENSRegistry
        {
            ...
            assets: new Map([
                ['EnsRegistry', { file: "./abis/Registry.json" }],
            ]),
            mapping: {
                file: "./dist/index.js",
                handlers: [
        ...
        // Resolver
        {
            ...
            assets: new Map([
                ['Resolver', { file: "./abis/PublicResolver.json" }],
            ]),
            mapping: {
                file: "./dist/index.js",
                handlers: [
        ...
        // EthRegistrarControllerOld
        {
            ...
            assets: new Map([
                ['EthRegistrarControllerOld', { file: "./abis/EthRegistrarControllerOld.json" }],
            ]),
            mapping: {
                file: "./dist/index.js",
                handlers: [
                    {
                        ...
                        filter: {
                            topics: ["NameRegistered(string, bytes32, address,uint256,uint256)"],
                        },
                    },
                    {
                        kind: EthereumHandlerKind.Event,
        ...
        // EthRegistrarController
        {
            ...
            assets: new Map([
                ['EthRegistrarController', { file: "./abis/EthRegistrarController.json" }],
            ]),
            mapping: {
                file: "./dist/index.js",
                handlers: [
                    {
                        ...
                        filter: {
                            topics: ["NameRegistered(string, bytes32, address,uint256,uint256,uint256)"],
                        },
                    },
                    {
                        kind: EthereumHandlerKind.Event,
        ...
        // NameWrapper
        {
            ...
            assets: new Map([
                ['NameWrapper', { file: "./abis/NameWrapper.json" }],
            ]),
            mapping: {
                file: "./dist/index.js",
                handlers: [
                    ...
                    },
                    {
                        ...
                        filter: {
                            topics: ["TransferSingle( address, address, address,uint256,uint256)"],
                        },
                    },
                    {
                        kind: EthereumHandlerKind.Event,
                        ...
                        filter: {
                            topics: ["TransferBatch( address, address, address,uint256[],uint256[])"],
                        },
                    }
                ],
            },
